...
class CardTiles extends ConsumerWidget {
      ...
      data: (markerData) {
        ...
        return Container(
          ...
          child: PageView(
            ...
            children: _tiles(mapMarkerList, markerRepository, context),
          ),
        );
      },
  ...
  List<Widget> _tiles(List<MapMarker> mapMarkerList,
      MarkerRepository markerRepository, BuildContext context) {
